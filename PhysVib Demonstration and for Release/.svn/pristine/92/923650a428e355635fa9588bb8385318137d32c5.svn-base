 ...
 */
public abstract class CustomBaseGameActivity extends BaseActivity implements IGameInterface, IRendererListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	protected synchronized void onCreateGame() {
		...
		final OnPopulateSceneCallback onPopulateSceneCallback = new OnPopulateSceneCallback() {
			...
			public void onPopulateSceneFinished() {
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onGameCreated" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					CustomBaseGameActivity.this.onGameCreated();
				} catch(final Throwable pThrowable) {
					Debug.e(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onGameCreated failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
		...
		final OnCreateSceneCallback onCreateSceneCallback = new OnCreateSceneCallback() {
			...
			public void onCreateSceneFinished(final Scene pScene) {
				...
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onPopulateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					CustomBaseGameActivity.this.onPopulateScene(pScene, onPopulateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onPopulateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
		...
		final OnCreateResourcesCallback onCreateResourcesCallback = new OnCreateResourcesCallback() {
			...
			public void onCreateResourcesFinished() {
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onCreateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					CustomBaseGameActivity.this.onCreateScene(onCreateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(CustomBaseGameActivity.this.getClass().getSimpleName() + ".onCreateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
